...
gas_params.forEach((gas, i) => {
    ...
    if (standard == 1) {
        ...
        lastppmvalue = Math.round(limit(Sensorppm(adjusted_valuea, adjusted_valueb, SensorValue, CorrectionCoefficient(temperature, rh)), 1, maxair * CorrectionCoefficient(temperature, rh)));
    } else {
