WARNING: To run the code, move the PredictData.py file from the Requirements folder to the following path: C:\Users\user\AppData\Local\Programs\Python\Python311\Lib\site-packages\PredictData.py.
...
This code uses 68 different models for Sensor Percentage when making predictions and selects the one with the highest accuracy rate for each.
