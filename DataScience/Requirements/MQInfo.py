...
def MQ306A():
    ...
    gas_params = [
        {'name': 'Ethanol', 'ppmvals': (100, 3000), 'ppm': (3.3559, -0.3563), 'calvalue': 0.976666},
...
def MQ307A():
    ...
    gas_params = [
        ...
        {'name': 'H2', 'ppmvals': (1000, 3000), 'ppm': (25051.8177, -0.8318), 'calvalue': 0.999572}
    ]
    group2_subgroup4()
...
def MQ309A():
    ...
    gas_params = [
        ...
        {'name': 'alcohol', 'ppmvals': (100, 10000), 'ppm': (34.1956, -0.2666), 'calvalue': 0.988237},
        {'name': 'CO', 'ppmvals': (100, 10000), 'ppm': (30.3019, -0.2336), 'calvalue': 0.988237}
    ]
    group2_subgroup2()
